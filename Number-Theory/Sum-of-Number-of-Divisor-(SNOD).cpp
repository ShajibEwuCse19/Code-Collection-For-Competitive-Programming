...
উত্তরঃ ( ১০ / ২ ) - ২ = ( ৫ - ২ ) = ৩ টি --> ৩ , ৪ , ৫ --> ( ২ , ৩ ) = ৬ , ( ২ , ৪ ) = ৮ , ( ২ , ৫ ) = ১০ --> ( ২ < b )
Formula : { ( N / a ) - a } = answer 

সুতরাং Divisor Pairt বের করতে হবে ১ থেকে ১০ পর্যন্ত কতগুলো সংখ্যা আছে যেখানে ( a < b ) , ১ থেকে sqrt(10) পর্যন্ত লুপ চালিয়ে,
...
ans = ans ( a > b ) = ans ( a < b ). অর্থাৎ আমরা যদি ( 2 , 4 ) পাই ডিভাইজর পেয়ার এ তাহলে অবশ্যই ( 4 , 2 ) পাবো ডিভাইজর পেয়ার এ।
    = 2 x ans ( a < b ) এখানে, ( a < b ) এর মান পূর্বেই বের করা হয়েছে। 
